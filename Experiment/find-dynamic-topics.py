...
def main():
	...
	# NMF implementation
	impl = unsupervised.nmf.SklNMF( max_iters = options.maxiter, init_strategy = "nndsvd", random_seed = random_seed, alpha_W = options.alpha_W, alpha_H = options.alpha_H, l1_ratio = options.l1_ratio) #改进
	...
	for k in range(kmin,kmax+1):
		...
		joblib.dump(impl.model, dir_out+'\\model_save\\dynamic_model'+str(k)+'.model') #改进

	# filepath='F:\\Desktop\\model_save\\dynamic_modelcoherence.csv'
	filepath=dir_out+'\\model_save\\dynamic_modelcoherence.csv' #改进
